...
function CalendarScheduleView({ onViewDetails, onCreateAppointment }) {
            ...
            <div className="overflow-hidden rounded-xl border border-gray/20 bg-white shadow-sm">
                        ...
                        {visibleDays.map(function (day) {
                            ...
                            const dayAppointments = filteredAppointments.filter(
                                function (appointment) {
                                    return appointment.day === dayName;
                                }
                            );
                            ...
                            return (
                                <div key={day.toISOString()} className="relative">
                                    ...
                                    {dayAppointments.map(function (appointment) {
                                        ...
                                        const duration =
                                            getMinutes(appointment.endTime) -
                                            getMinutes(appointment.startTime);
                ...
                <div className="flex flex-wrap items-center gap-3 border-t border-gray/20 px-3 py-3 sm:gap-5 sm:px-5 sm:py-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-slate">Confirmed</span>
                    </div>
                    <div className="flex items-center gap-2">
